...
### <ins>13. ファイルプレビュー機能 [ver1.10.0-]</ins>
添付されているPDFファイル、txtファイルのプレビューを表示します。
...
### 2026/04/14 ver.1.9.2
- 「8. 成績更新通知機能」の設定が、未提出課題の有無によって表示されない不具合を修正しました。（Contributor: @satokae さん)
### 2026/08/15 ver1.10.0
- 「13. ファイルプレビュー機能」を追加